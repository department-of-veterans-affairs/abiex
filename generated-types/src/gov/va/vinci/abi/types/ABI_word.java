 ...
 * @generated */
public class ABI_word extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ABI_word.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ABI_word() {/* intentionally empty block */}
   ...
   */
  public ABI_word(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public ABI_word(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
