 ...
 * @generated */
public class ABI_anatomy extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ABI_anatomy.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ABI_anatomy() {/* intentionally empty block */}
   ...
   */
  public ABI_anatomy(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public ABI_anatomy(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
