 ...
 * @generated */
public class ABI_score extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ABI_score.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ABI_score() {/* intentionally empty block */}
   ...
   */
  public ABI_score(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public ABI_score(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
