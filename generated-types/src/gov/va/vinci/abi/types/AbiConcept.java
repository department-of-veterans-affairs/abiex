 ...
 * @generated */
public class AbiConcept extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(AbiConcept.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected AbiConcept() {/* intentionally empty block */}
   ...
   */
  public AbiConcept(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public AbiConcept(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
