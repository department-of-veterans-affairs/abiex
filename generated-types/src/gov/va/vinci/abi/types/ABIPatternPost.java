 ...
 * @generated */
public class ABIPatternPost extends AnnotationPatternType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ABIPatternPost.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ABIPatternPost() {/* intentionally empty block */}
   ...
   */
  public ABIPatternPost(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public ABIPatternPost(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public ABIPatternPost(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
