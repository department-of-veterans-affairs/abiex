 ...
 * @generated */
public class Irrelevant_Index extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Irrelevant_Index.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Irrelevant_Index() {/* intentionally empty block */}
   ...
   */
  public Irrelevant_Index(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public Irrelevant_Index(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public Irrelevant_Index(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
