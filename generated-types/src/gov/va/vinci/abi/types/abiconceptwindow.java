 ...
 * @generated */
public class abiconceptwindow extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(abiconceptwindow.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected abiconceptwindow() {/* intentionally empty block */}
   ...
   */
  public abiconceptwindow(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public abiconceptwindow(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public abiconceptwindow(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
