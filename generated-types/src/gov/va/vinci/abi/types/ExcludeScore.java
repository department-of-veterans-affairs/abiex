 ...
 * @generated */
public class ExcludeScore extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ExcludeScore.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ExcludeScore() {/* intentionally empty block */}
   ...
   */
  public ExcludeScore(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public ExcludeScore(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
