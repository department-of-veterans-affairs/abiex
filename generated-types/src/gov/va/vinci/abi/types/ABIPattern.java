 ...
 * @generated */
public class ABIPattern extends AnnotationPatternType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ABIPattern.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ABIPattern() {/* intentionally empty block */}
   ...
   */
  public ABIPattern(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public ABIPattern(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
