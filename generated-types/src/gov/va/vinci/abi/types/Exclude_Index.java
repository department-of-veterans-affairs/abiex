 ...
 * @generated */
public class Exclude_Index extends AnnotationPatternType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Exclude_Index.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Exclude_Index() {/* intentionally empty block */}
   ...
   */
  public Exclude_Index(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public Exclude_Index(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public Exclude_Index(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
