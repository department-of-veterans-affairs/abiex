 ...
 * @generated */
public class Laterality extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Laterality.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Laterality() {/* intentionally empty block */}
   ...
   */
  public Laterality(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Laterality(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
